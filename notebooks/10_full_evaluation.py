...
# %% Step 3: Resolution Ablation (standard variant at 5 resolutions)
...
!python scripts/benchmark_models.py --tasks det --variants standard,quantized --imgsz 160,224,320,416,640
...
#
# # Resolution sweep
# python scripts/train.py --task det --variant standard --imgsz 160,224,320,416,640 --sweep --epochs 50
#
# # Metrics report
# python notebooks/09_metrics_report.py
#
